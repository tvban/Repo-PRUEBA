...
BUILDFILE      = 'https://gtkingbuild.github.io/wizard/xml/19builds.txt'
...
THEME1 = u'[COLOR {color1}][I]([COLOR {color1}][B]GTKin [/B][/COLOR][COLOR {color2}]Wizard[COLOR {color1}]) [/I][/COLOR] [COLOR {color2}]{{}}[/COLOR]'.format(color1=COLOR1, color2=COLOR2)
...
HIDECONTACT    = 'No'
# You can add \n to do line breaks
CONTACT        = 'Gracias por utilizar GTKING Build. Si quieres ponerte en contacto utiliza Telegram'
...
WIZARDFILE     = 'https://gtkingbuild.github.io/wizard/xml/19builds.txt'
#########################################################
